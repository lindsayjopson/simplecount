      ...
      <div className="h-full">
          <div
            ...
            <div className="py-8 h-full flex flex-col justify-between">
              <img className="flex flex-col items-center m-auto w-32 mt-6" src={MovioLogo} />
              <div className="flex flex-col items-center absolute top-1/3 w-full">
                ...
                <img className="flex flex-col items-center m-auto fixed bottom-0" style={{width: '900px'}} src={VegasBg} />
                <div>
                  <TimerComp />
                </div>
              </div>
